...
public area and perimeter methods, and allows printing #'s, deltes
and has a public attribute that keeps track of number of instances
"""
...
class Rectangle:
    ...
    Args:
        ...
        height (int): height
    Attributes:
        number_of_instances (int): number of instances created and deleted
